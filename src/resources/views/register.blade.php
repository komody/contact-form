      ...
      <form class="auth-form" action="/register" method="post" novalidate>
        ...
        <div class="auth-form-group">
          ...
          <div class="auth-form-input">
            <input class="auth-form-input-field" type="text" name="name" value="{{ old('name') }}" placeholder="例:山田 太郎" />
          </div>
          @error('name')
        ...
        <div class="auth-form-group">
          ...
          <div class="auth-form-input">
            <input class="auth-form-input-field" type="password" name="password" placeholder="例:coachtech106" />
          </div>
          @error('password')
          <div class="auth-form-error">{{ $message }}</div>
          @enderror
